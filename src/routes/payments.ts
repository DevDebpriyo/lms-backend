          ...
          if (email) {
            ...
            if (payment?.subscription_id) {
              try {
                ...
                update.subscription.interval = plan ? (plan === 'yearly' ? 'year' : 'month') : (inferPlanFromInterval(subscription?.subscription_period_interval) || inferPlanFromInterval(subscription?.payment_frequency_interval)) || null;
